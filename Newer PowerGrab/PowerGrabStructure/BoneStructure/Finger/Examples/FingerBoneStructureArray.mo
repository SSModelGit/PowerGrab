...
model FingerBoneStructureArray
  PowerGrabStructure.BoneStructure.Finger.Basic.Examples.BoneJointComponent
    boneCDistal(
  ...
  Sources.FingerLoad fingerLoad(
    ...
    r1=r_OboneFDistal[1]/2) annotation (Placement(visible=true, transformation(
        ...
        rotation=0)));
equation
  connect(fingerLoad.tau3, boneCDistal.LoadTorque) annotation(Line(visible = true, origin = {-53.435, 31.839}, points = {{13.093, 36.245}, {17.63, 36.245}, {17.63, -17.826}, {-24.176, -17.826}, {-24.176, -36.839}}, color = {0, 0, 127}));
  connect(fingerLoad.tau2, boneMDistal.LoadTorque) annotation(Line(visible = true, origin = {-23.344, 46.846}, points = {{-17.201, 25.923}, {8.6, 25.923}, {8.6, -51.846}}, color = {0, 0, 127}));
  connect(fingerLoad.tau1, boneFDistal.LoadTorque) annotation(Line(visible = true, origin = {20.073, 36.21}, points = {{-60.698, 41.21}, {15.386, 41.21}, {15.386, -41.21}, {29.927, -41.21}}, color = {0, 0, 127}));
  connect(boneMDistal.y, fingerLoad.theta2) annotation(Line(visible = true, origin = {-56.343, 28.568}, points = {{32.099, -34.568}, {-12.043, -34.568}, {-12.043, 34.568}, {-8.013, 34.568}}, color = {0, 0, 127}));
  connect(boneFDistal.y, fingerLoad.theta1) annotation(Line(visible = true, origin = {-40.113, 32.958}, points = {{80.613, -38.958}, {-28.274, -38.958}, {-28.274, 38.958}, {-24.065, 38.958}}, color = {0, 0, 127}));
  connect(loadForce, fingerLoad.force) annotation(Line(visible = true, origin = {-75.63800000000001, 72.17400000000001}, points = {{-25.962, -7.71}, {7.251, -7.71}, {7.251, 7.71}, {11.46, 7.71}}, color = {0, 0, 127}));
  ...
  connect(boneCDistal.frame_b, frame_5A) annotation(Line(visible = true, origin = {-49.17, 40.381}, points = {{-18.34, -31.81}, {9.17, -31.81}, {9.17, 63.619}}));
  ...
  connect(boneMDistal.frame_b, frame_3A) annotation(Line(visible = true, origin = {25.119, 40.381}, points = {{-29.762, -31.81}, {14.881, -31.81}, {14.881, 63.619}}));
  ...
  connect(boneFDistal.frame_b, frame_1A) annotation(Line(visible = true, origin = {100.034, 40.381}, points = {{-39.933, -31.81}, {19.966, -31.81}, {19.966, 63.619}}));
  ...
  connect(frame_a, boneCDistal.frame_a) annotation(Line(visible = true, origin = {-117.769, 0}, points = {{-30.158, 0}, {30.158, 0}}));
  connect(thetaFDistal, boneFDistal.thetaControl) annotation(Line(visible = true, origin = {64.93300000000001, 14.737}, points = {{14.666, 11.737}, {-0.14, 11.737}, {-0.14, -11.737}, {-14.386, -11.737}}, color = {0, 0, 127}));
  connect(thetaMDistal, boneMDistal.thetaControl) annotation(Line(visible = true, origin = {-4.491, 13.27}, points = {{9.706, 12.784}, {9.706, -1.257}, {-9.706, -1.257}, {-9.706, -10.27}}, color = {0, 0, 127}));
  connect(thetaCDistal, boneCDistal.thetaControl) annotation(Line(visible = true, origin = {-70.39100000000001, 13.365}, points = {{6.673, 13.071}, {6.673, -1.353}, {-6.673, -1.353}, {-6.673, -10.365}}, color = {0, 0, 127}));
  ...
  connect(boneCDistal.frame_a, posteriorBase.frame_b) annotation(Line(visible = true, origin = {-108.807, -20.875}, points = {{21.196, 20.875}, {-6.028, 20.875}, {-6.028, -20.875}, {-9.140000000000001, -20.875}}));
  connect(boneMDistal.frame_b2, boneFDistal.frame_a) annotation(Line(visible = true, origin = {26.569, 0.238}, points = {{-31.212, 0.238}, {8.890000000000001, 0.238}, {8.890000000000001, -0.238}, {13.431, -0.238}}));
  connect(boneCDistal.frame_b2, boneMDistal.frame_a) annotation(Line(visible = true, origin = {-37.706, 0.238}, points = {{-29.804, 0.238}, {8.420999999999999, 0.238}, {8.420999999999999, -0.238}, {12.962, -0.238}}));
