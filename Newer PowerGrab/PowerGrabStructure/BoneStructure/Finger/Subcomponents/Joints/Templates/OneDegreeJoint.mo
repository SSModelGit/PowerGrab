...
equation
  ...
  connect(restrainedRevolute.frame_b, frame_b) annotation (Line(
      ...
      color={95,95,95},
      thickness=0.5));
  connect(restrainedRevolute.flange_b, flange_b1) annotation (Line(points={{-8.2552,
          10},{-16,10},{-16,67.028},{-23,67.028}}, color={0,0,0}));
  connect(restrainedRevolute.flange_a, flange_a1) annotation (Line(points={{-3.5029,
          10},{-3.5029,37},{22,37},{22,67.069}}, color={0,0,0}));
end OneDegreeJoint;
