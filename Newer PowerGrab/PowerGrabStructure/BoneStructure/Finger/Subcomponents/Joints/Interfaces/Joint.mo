...
partial model Joint "Joint Interface"
  ...
  Modelica.Mechanics.Rotational.Interfaces.Flange_a flange_a1 if useAxisFlange annotation(Placement(visible = true, transformation(origin = {22, 67.069}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-23.029, 100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Mechanics.Rotational.Interfaces.Flange_b flange_b1 if useAxisFlange annotation(Placement(visible = true, transformation(origin = {-23, 67.028}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-54.552, 100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
