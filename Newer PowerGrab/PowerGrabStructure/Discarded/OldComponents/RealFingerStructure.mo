...
model RealFingerStructure
  PowerGrabStructure.BoneStructure.Finger.Basic.Examples.RealBoneJoint
    boneMDistal(
  ...
  PowerGrabStructure.Sources.FingerLoad fingerLoad(
    r2=r_OboneMDistal[1],
    r3=r_OboneCDistal[1],
  ...
  PowerGrabStructure.BoneStructure.Finger.Basic.Examples.RealBoneDoubleJoint
    boneCDistal(
    ...
    phi_0_regularJoint=phi_0_boneCDistal) annotation (Placement(visible=
          true, transformation(
        origin={-86.959,-2.646},
        extent={{-10,-10},{10,10}},
        rotation=0)));
