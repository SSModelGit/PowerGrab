within PowerGrabStructure.Tests.Muscles;
model TestNewMuscle

  PowerGrabStructure.Muscle.Basic.Examples.NewMuscle newMuscle(
    k_min_a=1000,
    k_max_a=1100,
    x_min_a=0.5,
    x_max_a=1,
    ...
    k_max_p=1100,
    x_min_p=0.6,
    x_max_p=1.1) annotation (Placement(visible=true, transformation(
        origin={0,75},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  ...
  BoneStructure.Finger.Subcomponents.Joints.Examples.OneDegreeJoint
    revoluteRestrained(
    phi_0_restrained=0,
    theta_1=-0.1,
    theta_2=1.6,
  ...
  Modelica.Blocks.Sources.Constant const3(k = 0) annotation(Placement(visible = true, transformation(origin = {-125, 47.531}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(world.frame_b, fixedRotation.frame_a) annotation(Line(visible = true, origin = {-121.512, -50.295}, points={{-0.007,
          -16.761},{3.118,-16.761},{3.118,-3.535},{-3.081,-3.535},{-3.081,
          20.295},{-0.069,20.295}}));
  ...
  connect(const3.y, newMuscle.xPercent_a) annotation(Line(visible = true, origin = {-38.256, 59.113}, points={{-75.744,
          -11.582},{23.244,-11.582},{23.244,11.583},{29.256,11.583}},                                                                                                                       color = {0, 0, 127}));
  connect(const.y, newMuscle.kPercent_a) annotation(Line(visible = true, origin = {-38.138, 77.806}, points={{-75.862,
          -0.195},{23.125,-0.195},{23.125,0.194},{29.6129,0.194}},                                                                                                                                color = {0, 0, 127}));
  connect(newMuscle.frame_resolve, fixedTranslation5.frame_b) annotation(Line(visible = true, origin = {-9.829000000000001, 66.33}, points={{9.829,
          18.67},{9.829,23.216},{-5.184,23.216},{-5.184,-6.021},{-2.059,-6.021},
          {-2.059,-26.33},{-5.171,-26.33}}));
  ...
  connect(newMuscle.frame_b, fixedTranslation1.frame_b) annotation(Line(visible = true, origin = {22.086, 62.199}, points={{-12.086,
          23.0451},{-12.086,27.346},{7.02,27.346},{7.02,-38.868},{10.132,
          -38.868}}));
  connect(newMuscle.frame_resolve1, fixedTranslation4.frame_b) annotation(Line(visible = true, origin = {1.245, 18.539}, points={{-1.245,
          46.461},{-1.245,41.77},{1.868,41.77},{1.868,-65.106},{-1.245,-65.106}}));
  connect(newMuscle.frame_a1, fixedTranslation2.frame_b) annotation(Line(visible = true, origin = {-54.933, 27.123}, points={{45.1268,
          37.877},{45.1268,33.185},{-31.122,33.185},{-31.122,-52.123},{-28.009,
          -52.123}}));
  ...
  connect(add1.y, position.phi_ref) annotation(Line(visible = true, origin = {79.32599999999999, 40}, points={{9.674,0},
          {-9.673,0}},                                                                                                                                             color = {0, 0, 127}));
  ...
  connect(revoluteRestrained.flange_a, relAngleSensor.flange_b) annotation(Line(visible = true, origin = {42.428, 1.9}, points={{
          -49.9309,-3.983},{-49.9309,-0.983},{-39.428,-0.983},{-39.428,-5.125},
          {60.572,-5.125},{60.572,8.1},{57.572,8.1}}));
  connect(revoluteRestrained.flange_b, relAngleSensor.flange_a) annotation(Line(visible = true, origin = {18.497, 5.972}, points={{
          -30.7522,-8.055},{-30.7522,4.028},{61.503,4.028}}));
