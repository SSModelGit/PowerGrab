...
model TrialOpposableFingers
  DiscardedPowerGrabModels.OldComponents.ObjectLFConnection objectLFConnection(threshold=
  ...
  DiscardedPowerGrabModels.OldComponents.ObjectLFConnection objectLFConnection1(threshold=
       0.75) annotation (Placement(visible=true, transformation(
        origin={5,-33.214},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  ...
  DiscardedPowerGrabModels.OldComponents.ObjectLFConnection objectLFConnection2(threshold=
       0.75) annotation (Placement(visible=true, transformation(
        origin={-25,10},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  DiscardedPowerGrabModels.OldComponents.ObjectLFConnection objectLFConnection3(threshold=
       0.75) annotation (Placement(visible=true, transformation(
        origin={-25,43.039},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  DiscardedPowerGrabModels.OldComponents.ObjectLFConnection objectLFConnection4(threshold=
       0.75) annotation (Placement(visible=true, transformation(
        origin={5,-15},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  DiscardedPowerGrabModels.OldComponents.ObjectLFConnection objectLFConnection5(threshold=
       0.75) annotation (Placement(visible=true, transformation(
        origin={5,-50},
        extent={{-10,-10},{10,10}},
        rotation=0)));
