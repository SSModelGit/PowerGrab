...
model TestObjCPrism
  PowerGrabStructure.Muscle.Examples.FingerMuscleLineArray anteriorMuscleArray(
    ...
    maxCDistal=200) annotation (Placement(visible=true, transformation(
        ...
        rotation=0)));
  DiscardedPowerGrabModels.OldComponents.FingerMultipleRevoluteArray fingerBoneStructureArray(
  ...
  DiscardedPowerGrabModels.OldComponents.ObjectPrismConnection objectPRISMConnection(
