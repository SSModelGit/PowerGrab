...
model ObjectConnectionToBareBoneTest
  ...
  DiscardedPowerGrabModels.OldComponents.ObjectLFConnection objectLFConnection(
    threshold=0.25,
    k=5000,
    dampingCoefficient=5000) annotation (Placement(visible=true, transformation(
        origin={-42.837,30},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  PowerGrabTestingRig.BoneStructure.Subcomponents.Finger.Subcomponents.Basic.Subcomponents.BoneDoubleJointComponent
    boneDoubleJointComponent(closedDoubleJoint=false, closedRegularJoint=false)
  ...
  model TestOCLFtoWholeFingerArray
    DiscardedPowerGrabModels.OldComponents.ObjectLFConnection objectLFConnection(threshold=
         0.25) annotation (Placement(visible=true, transformation(
          origin={-10,27.15},
          extent={{-10,-10},{10,10}},
          rotation=0)));
