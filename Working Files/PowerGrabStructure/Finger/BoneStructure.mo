...
package BoneStructure "Bone Structure Components"
  ...
  package Templates
    partial model FingerStructure
      ...
      extends
        PowerGrabStructure.Finger.BoneStructure.Interfaces.FingerStructure;
      ...
      replaceable
        PowerGrabStructure.Finger.BoneStructure.Basic.Templates.BoneJoint
        boneJoint
  ...
  package Basic
    ...
    package Templates
      ...
      partial model DoubleBoneJoint
        ...
        replaceable
          PowerGrabStructure.Finger.Muscle.Subcomponents.Interfaces.MagnitudeMuscle
          magnitudeMuscle annotation (Placement(transformation(extent={{-122,-92},
                  {-102,-72}})));
        replaceable
          PowerGrabStructure.Finger.Muscle.Subcomponents.Interfaces.DirMuscle
          dirMuscle2
    ...
    package Examples
      ...
      model RealBoneDoubleJoint
        ...
        extends
          ...
          fixedTranslation1(r={-r_OFingerBone[1]*0.5,-diameterOFingerBone*0.25,
                0}),
          revolute1(
            animation=false,
            n={0,0,1},
    ...
    package Subcomponents
      ...
      package Examples
        model RevoluteRestrained
          extends
            PowerGrabStructure.Finger.BoneStructure.Joints.Subcomponents.Interfaces.RestrainedRevolute;
  ...
  package Examples
    model RealFingerStructure
      import PowerGrabStructure;
      extends PowerGrabStructure.Finger.BoneStructure.Templates.FingerStructure(
        redeclare
          PowerGrabStructure.Finger.BoneStructure.Basic.Examples.RealBoneDoubleJoint
          doubleBoneJoint(
        ...
        redeclare
          PowerGrabStructure.Finger.BoneStructure.Basic.Examples.RealBoneJoint
          boneJoint1(
