within PowerGrabStructure.Finger.ContactObject.Examples;
model PrismDampingOC
  extends PowerGrabStructure.Finger.ContactObject.Interfaces.ObjectConnection;
  ...
  Components.NonLinearSpringDamper contactResistance(s_unstretched=threshold,
  ...
  Components.NonLinearSpringDamper skinBuffer(animation=false, s_unstretched=
        threshold + bufferRange) annotation (Placement(visible=true,
        transformation(
        origin={0,26.587},
        extent={{-10,-10},{10,10}},
        rotation=0)));
