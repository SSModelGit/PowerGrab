...
model RealBoneDoubleJoint
  ...
  extends BoneStructure.Finger.Subcomponents.Basic.Templates.DoubleBoneJoint(
    ...
    redeclare Joints.Examples.TwoDegreeJoint twoDegreeJoint, IFingerBone(r = r_IFingerBone, r_shape = r_shape_IFingerBone, color = {155, 0, 0}, diameter = diameterIFingerBone, animation = true,
  r_0(                                                                                                                                                                                 fixed =     false)), OFingerExtension(r = r_OFingerBone, r_shape = r_shape_OFingerBone,
  r_0(                                                                                                               fixed =     false),color = {255, 255, 0}, diameter = diameterOFingerBone, animation = true, specularCoefficient = 1),
  fixedTranslation1(r = {-r_OFingerBone[1] * 0.5, -diameterOFingerBone * 0.25, 0}), revolute1(animation = false, n = {0, 0, 1}, useAxisFlange = true,
  phi(                                                                                                           fixed =     false, start =     1.5),cylinderLength = 0.001, cylinderDiameter = 0.001), fixedTranslation3(r = {-0.5 * r_OFingerBone[1], diameterOFingerBone * 0.5, 0}),
  fixedTranslation5(r = {diameterOFingerBone * 0.6, 0, 0}), fixedTranslation(r = {-r_IFingerBone[1] * 0.5, 0, diameterOFingerBone * 0.1}), fixedTranslation2(r = {-r_IFingerBone[1] * 0.5, 0, diameterOFingerBone * 0.5}),
  fixedTranslation6(r = {-r_OFingerBone[1] * 0.5, 0, -diameterOFingerBone * 0.5}), fixedTranslation7(r = {-r_OFingerBone[1] * 0.5, 0, diameterOFingerBone * 0.5}), fixedTranslation8(r = {diameterOFingerBone * 0.6, 0, 0}), revolute3(animation = false, n = {0, 1, 0},
  phi(                                                                                     fixed =     false, start =     1.5),useAxisFlange = true, cylinderLength = 0.001, cylinderDiameter = 0.001), fixedTranslation9(r = {-diameterOFingerBone * 0.6, 0, 0}),
