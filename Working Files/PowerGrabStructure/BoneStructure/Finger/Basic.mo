within PowerGrabStructure.BoneStructure.Finger;
package Basic
  ...
  package Templates
    ...
    partial model DoubleBoneJoint
      ...
      replaceable
        PowerGrabStructure.BoneStructure.Finger.Joints.Templates.TwoDegreeJoint
        twoDegreeJoint
        annotation (Placement(transformation(extent={{-6,0},{14,20}})));
      replaceable Muscle.Subcomponents.Interfaces.MagnitudeMuscle
        magnitudeMuscle1 annotation (Placement(transformation(extent={{
                -120,80},{-100,100}})));
  ...
  package Examples
    ...
    model RealBoneDoubleJoint
      import PowerGrabStructure;
      extends
        PowerGrabStructure.BoneStructure.Finger.Basic.Templates.DoubleBoneJoint(
        ...
        redeclare
          PowerGrabStructure.BoneStructure.Finger.Joints.Examples.TwoDegreeJoint
          twoDegreeJoint,
        IFingerBone(
          r=r_IFingerBone,
    ...
    model RealBoneJoint
      extends PowerGrabStructure.BoneStructure.Finger.Basic.Templates.BoneJoint(
