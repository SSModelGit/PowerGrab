...
package Examples
  model RealFingerStructure
    extends PowerGrabStructure.BoneStructure.Finger.Templates.FingerStructure(
      redeclare Basic.Examples.RealBoneDoubleJoint doubleBoneJoint(
      ...
      redeclare Basic.Examples.RealBoneJoint boneJoint1(
      ...
      redeclare Basic.Examples.RealBoneJoint boneJoint(
