...
model RealHandContactTrialPrecision
  ...
  extends PowerGrabStructure.Templates.HandWithObject.HandContact(
    ...
    fixedRotation1(r={-0.10,0.04,0.01}), object_x = {-0.06, 0.15, 0});
  ...
  final parameter Modelica.SIunits.Length threshold = 0.0325;
...
connect(zero.y, opposable.posteriorInput[4]) annotation (Line(points={{
        ...
        127}));
  connect(zero.y, leftMostFinger.anteriorInput[3]) annotation (Line(points={{-151.714,
          55},{-30,55},{-30,-9.9454},{96.1678,-9.9454}}, color={0,0,127}));
  connect(zero.y, leftMostFinger.anteriorInput[2]) annotation (Line(points={{-151.714,
          55},{-30,55},{-30,-10.9454},{96.1678,-10.9454}}, color={0,0,127}));
  connect(zero.y, leftMostFinger.anteriorInput[1]) annotation (Line(points={{-151.714,
          55},{-30,55},{-30,-11.9454},{96.1678,-11.9454}}, color={0,0,127}));
...
end RealHandContactTrialPrecision;
