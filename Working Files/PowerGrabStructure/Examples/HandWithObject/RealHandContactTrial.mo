...
model RealHandContactTrial
  extends PowerGrabStructure.Templates.HandWithObject.HandContact(
    ...
    third=false,
    fourth=false,
    fifth=false, wrist.r_0.fixed = false);
  ...
  parameter Real mu = 0;
  parameter Modelica.SIunits.Length delta[2] = {0, 0} "In order of: delta of friction, buffer range";
  parameter Modelica.SIunits.Position object_x[3] = {-0.1, 0.1, -0.1};
