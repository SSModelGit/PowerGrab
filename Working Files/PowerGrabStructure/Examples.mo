    ...
    model RealHandContactTrial
      ...
      extends PowerGrabStructure.Templates.HandWithObject.HandContact(
        redeclare PowerGrabStructure.Finger.Examples.RealFingerContact
          middleMostFinger(
          threshold=threshold,
          fingerLength={mFinger*0.343137255,mFinger*0.31372549,mFinger*
              0.196078431,mFinger*0.147058824},
          mu=mu,
          delta=delta[1],
          k=500,
          phiSide0=0,
        ...
        redeclare PowerGrabStructure.Finger.Examples.RealFingerContact
          opposable(
          threshold=threshold,
          fingerLength={tFinger*0.137931034,tFinger*0.344827586,tFinger*
              0.275862069,tFinger*0.24137931},
          mu=mu,
          delta=delta[1],
          k=500,
          phiSide0=0,
        ...
        redeclare PowerGrabStructure.Finger.Examples.RealFingerContact
          middleLeftFinger(
          fingerLength={rFinger*0.319148936,rFinger*0.319148936,rFinger*
              0.212765957,rFinger*0.14893617},
          mu=mu,
          delta=delta[1],
          threshold=threshold,
          k=500,
        ...
        redeclare PowerGrabStructure.Finger.Examples.RealFingerContact
          leftMostFinger(
          fingerLength={lFinger*0.337837838,lFinger*0.324324324,lFinger*
              0.168918919,lFinger*0.168918919},
          mu=mu,
          delta=delta[1],
          threshold=threshold,
          k=500,
        ...
        redeclare PowerGrabStructure.Finger.Examples.RealFingerContact
          middleRight(
          fingerLength={iFinger*0.342857143,iFinger*0.342857143,iFinger*
              0.171428571,iFinger*0.142857143},
          mu=mu,
          delta=delta[1],
          threshold=threshold,
          k=500,
