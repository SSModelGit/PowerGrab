...
model MultiFingerContactTrial
  PowerGrabStructure.Examples.Finger.RealFingerContact middleMostFinger(
    ...
    bufferEffect=50) annotation (Placement(visible=true, transformation(
        ...
        rotation=0)));
  PowerGrabTestingRig.BoneStructure.Subcomponents.Finger.FingerContactArray opposable(
    mDistalClosed=false,
    cDistalRegularClosed=false,
    fDistalClosed=false,
    cDistalSideClosed=false,
    ...
    fingerLength={tFinger*0.137931034,tFinger*0.344827586,tFinger*0.275862069,
        tFinger*0.24137931},
    mu=mu,
    delta=delta) if second annotation (Placement(visible=true, transformation(
  ...
  PowerGrabTestingRig.BoneStructure.Subcomponents.Finger.FingerContactArray middleLeftFinger(
    fDistalClosed=false,
    mDistalClosed=false,
    cDistalRegularClosed=false,
    cDistalSideClosed=false,
    ...
    mu=mu,
    delta=delta,
    threshold=threshold) if third annotation (Placement(visible=true,
        transformation(
        origin={98.56100000000001,25.357},
        extent={{-12.5,-12.5},{12.5,12.5}},
        rotation=0)));
  PowerGrabTestingRig.BoneStructure.Subcomponents.Finger.FingerContactArray leftMostFinger(
    fDistalClosed=false,
    mDistalClosed=false,
    cDistalRegularClosed=false,
    cDistalSideClosed=false,
    ...
    mu=mu,
    delta=delta,
    threshold=threshold) if fourth annotation (Placement(visible=true,
        transformation(
        origin={97.998,-14.643},
        extent={{-12.5,-12.5},{12.5,12.5}},
        rotation=0)));
  PowerGrabTestingRig.BoneStructure.Subcomponents.Finger.FingerContactArray middleRight(
    fDistalClosed=false,
    mDistalClosed=false,
    cDistalRegularClosed=false,
    cDistalSideClosed=false,
    ...
    mu=mu,
    delta=delta,
    threshold=threshold) if fifth annotation (Placement(visible=true,
        transformation(
        origin={97.998,-56.5},
        extent={{-12.5,-12.5},{12.5,12.5}},
        rotation=0)));
  ...
  PowerGrabTestingRig.BoneStructure.Subcomponents.Finger.RealTestFinger realTestFinger
