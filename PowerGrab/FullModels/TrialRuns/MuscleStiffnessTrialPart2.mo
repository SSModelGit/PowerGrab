...
model MuscleStiffnessTrialPart2
  ...
  PowerGrab.Components.RevoluteRestrained revoluteRestrained(phi_0_restrained = 1.5, theta_1 = -0.1, theta_2 = 1.6, useAxisFlange = true) annotation(Placement(visible = true, transformation(origin = {-10, -12.083}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  PowerGrab.Components.NeuralMuscle neuralMuscle(f_max_a = 200, f_max_p = 200) annotation(Placement(visible = true, transformation(origin = {-10, 75}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
