...
model TestPrismaticRestrictedOneDTranslation
  ...
  Modelica.Mechanics.MultiBody.Parts.Body body(r_CM = {0, 0, 0}, m = 1, r_0.start = {0, 2, 0}, r_0.fixed = true) annotation(Placement(visible = true, transformation(origin = {30, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
