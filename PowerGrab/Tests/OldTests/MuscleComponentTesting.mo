...
model MuscleComponentTesting
  ...
  Modelica.Mechanics.MultiBody.Parts.Body body(m = 1, r_CM = {0.001, 0, 0}, r_0.fixed = false) annotation(Placement(visible = true, transformation(origin = {135, -0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
