...
model TestHingeMuscleJointComponent
  ...
  Modelica.Mechanics.MultiBody.Parts.BodyShape bodyShape(r = {0, 0.01, 0}, r_CM = {0, 0.005, 0}, m = 1, r_0.fixed = true, r_0.start = {0, 1, 0}) annotation(Placement(visible = true, transformation(origin = {101.6, 5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
