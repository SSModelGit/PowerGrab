...
model TestHingeMuscleJointUpwrdsBsc
  ...
  Modelica.Mechanics.MultiBody.Parts.BodyShape bodyShape(r = {0, 0, 0}, r_CM = {0, 0, 0}, m = 1, r_0.start = {0, 0.5, 0}) annotation(Placement(visible = true, transformation(origin = {-0, 65}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
