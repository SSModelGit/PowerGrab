...
model TestHingeMuscleJointLineForceWMBSC
  ...
  Modelica.Mechanics.MultiBody.Parts.BodyShape bodyShape(r_0.start = {0, 0.5, 0}, r = {0, 0.001, 0}, r_CM = {0, 0.0005, 0}, m = 1, r_0.fixed = true) annotation(Placement(visible = true, transformation(origin = {36.777, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
