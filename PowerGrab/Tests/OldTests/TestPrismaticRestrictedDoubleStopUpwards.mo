...
model TestPrismaticRestrictedDoubleStopUpwards
  Modelica.Mechanics.MultiBody.Joints.Prismatic prismatic(useAxisFlange = true, s.fixed = false, n = {0, 1, 0}) annotation(Placement(visible = true, transformation(origin = {-2.469, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Mechanics.MultiBody.Parts.Body body(r_CM = {0, 0, 0}, m = 1, r_0.start = {0, 0.5, 0}, r_0.fixed = true) annotation(Placement(visible = true, transformation(origin = {30, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
