...
model RevoluteRestrainedTest
  ...
  Components.RevoluteRestrained sideRevolute(theta_1 = -0.87, theta_2 = 0.87, phi_0_restrained = 0.05, useAxisFlange = true, axisRotation = {0, 1, 0}) annotation(Placement(visible = true, transformation(origin = {-50, -0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Components.RevoluteRestrained normalRevolute(phi_0_restrained = 0.05, theta_1 = -0.1, theta_2 = 1.47, useAxisFlange = true) annotation(Placement(visible = true, transformation(origin = {-20, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  connect(torque1.flange, sideRevolute.flange_a) annotation(Line(visible = true, origin = {-13.296, 39.2}, points = {{20.805, 40.8}, {23.805, 40.8}, {23.805, -26.2}, {-34.207, -26.2}, {-34.207, -29.2}}));
  ...
  connect(torque.flange, normalRevolute.flange_a) annotation(Line(visible = true, origin = {-31.669, 33.333}, points = {{-28.331, 11.667}, {14.166, 11.667}, {14.166, -23.333}}));
  connect(normalRevolute.frame_b, bodyCylinder.frame_a) annotation(Line(visible = true, origin = {1.274, 0}, points = {{-13.726, 0}, {13.726, 0}}));
  connect(sideRevolute.frame_b, normalRevolute.frame_a) annotation(Line(visible = true, origin = {-35.023, -0}, points = {{-7.428, -0}, {7.428, 0}}));
  ...
  connect(fixedRotation.frame_b, sideRevolute.frame_a) annotation(Line(visible = true, origin = {-78.798, -0}, points = {{-21.202, -0}, {21.202, 0}}));
