...
model TestNewMuscle
  PowerGrab.Components.OldComponents.NewMuscle newMuscle(k_min_a = 1000, k_max_a = 1100, x_min_a = 0.5, x_max_a = 1, k_min_p = 1000, k_max_p = 1100, x_min_p = 0.6, x_max_p = 1.1) annotation(Placement(visible = true, transformation(origin = {0, 75}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
