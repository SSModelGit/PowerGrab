...
model BoneMuscleJointExperimentalComponentTest "Testing the experimental fundamental unit component for validity"
...
equation
  connect(ramp.y, boneMuscleJointComponent.F_A) annotation(Line(visible = true, origin = {-35.398, 26.305}, points = {{-71.194, 18.695}, {22.398, 18.695}, {22.398, -18.695}, {26.398, -18.695}}, color = {0, 0, 127}));
  connect(const.y, boneMuscleJointComponent.F_P) annotation(Line(visible = true, origin = {-36, -31.153}, points = {{-73, -23.847}, {23, -23.847}, {23, 23.847}, {27, 23.847}}, color = {0, 0, 127}));
  connect(boneMuscleJointComponent.LoadTorque, const1.y) annotation(Line(visible = true, origin = {19.881, -28.704}, points = {{-9.358000000000001, 21.296}, {4.119, 21.296}, {4.119, -21.296}, {1.119, -21.296}}, color = {0, 0, 127}));
