...
model TestBoneJointComponent
  ...
  PowerGrab.Components.BoneJointComponent boneJointComponent1(phi_0_restrained = 0.65, r_IFingerBone = {0.25, 0, 0}) annotation(Placement(visible = true, transformation(origin = {63.5, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PowerGrab.Components.NeuralMuscle neuralMuscle1(f_max_a = 200, f_max_p = 200) annotation(Placement(visible = true, transformation(origin = {65, 42.921}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(const2.y, neuralMuscle.forcePValue_a) annotation(Line(visible = true, origin = {-20.676, 49.566}, points = {{-23.324, 3.455}, {5.664, 3.455}, {5.664, -3.455}, {11.996, -3.455}}, color = {0, 0, 127}));
  connect(const4.y, neuralMuscle1.forcePValue_p) annotation(Line(visible = true, origin = {80.048, 62.143}, points = {{25.952, 17.857}, {28.952, 17.857}, {28.952, 4.845}, {-30.06, 4.845}, {-30.06, -22.702}, {-23.736, -22.702}}, color = {0, 0, 127}));
  connect(const5.y, neuralMuscle1.forcePValue_a) annotation(Line(visible = true, origin = {65.04900000000001, 64.562}, points = {{10.951, 15.438}, {13.951, 15.438}, {13.951, 2.425}, {-15.062, 2.425}, {-15.062, -17.863}, {-8.73, -17.863}}, color = {0, 0, 127}));
  connect(const.y, boneJointComponent1.LoadTorque) annotation(Line(visible = true, origin = {41.964, -23.667}, points = {{-38.608, -18.667}, {8.536, -18.667}, {8.536, 18.667}, {21.536, 18.667}}, color = {0, 0, 127}));
  connect(boneJointComponent1.frame_b1, neuralMuscle1.frame_b1) annotation(Line(visible = true, origin = {76.998, 12.761}, points = {{-3.498, -20.161}, {2.748, -20.161}, {2.748, 20.161}, {-1.998, 20.161}}));
  connect(boneJointComponent1.frame_resolve1, neuralMuscle1.frame_resolve1) annotation(Line(visible = true, origin = {68.333, 8.897}, points = {{-4.833, -18.897}, {-4.833, -21.897}, {8.167, -21.897}, {8.167, 19.333}, {-3.333, 19.333}, {-3.333, 24.025}}, color = {95, 95, 95}));
  ...
  connect(boneJointComponent1.frame_b, neuralMuscle1.frame_b) annotation(Line(visible = true, origin = {76.61799999999999, 37.048}, points = {{-3.017, -28.477}, {3.127, -28.477}, {3.127, 20.419}, {-1.618, 20.419}, {-1.618, 16.117}}));
  ...
  connect(boneJointComponent.frame_b2, boneJointComponent1.frame_a) annotation(Line(visible = true, origin = {41.15, 0.238}, points = {{-31.049, 0.238}, {9.35, 0.238}, {9.35, -0.238}, {12.35, -0.238}}));
  connect(const.y, boneJointComponent.LoadTorque) annotation(Line(visible = true, origin = {3.214, -23.133}, points = {{0.143, -19.2}, {3.143, -19.2}, {3.143, 10.133}, {-3.214, 10.133}, {-3.214, 18.133}}, color = {0, 0, 127}));
  connect(neuralMuscle.frame_b1, boneJointComponent.frame_b1) annotation(Line(visible = true, origin = {12.367, 12.357}, points = {{-2.367, 19.976}, {2.378, 19.976}, {2.378, -19.976}, {-2.389, -19.976}}, color = {95, 95, 95}));
  connect(boneJointComponent.frame_b, neuralMuscle.frame_b) annotation(Line(visible = true, origin = {11.918, 36.696}, points = {{-1.817, -28.124}, {2.827, -28.124}, {2.827, 20.183}, {-1.918, 20.183}, {-1.918, 15.882}}));
  connect(neuralMuscle.frame_resolve1, boneJointComponent.frame_resolve1) annotation(Line(visible = true, origin = {-4.333, 8.603}, points = {{4.333, 23.731}, {4.333, 19.039}, {-8.667, 19.039}, {-8.667, -21.603}, {4.333, -21.603}, {4.333, -18.603}}));
  ...
  connect(neuralMuscle.frame_resolve, boneJointComponent.frame_resolve) annotation(Line(visible = true, origin = {-5.176, 33.682}, points = {{5.176, 18.651}, {5.176, 23.197}, {-9.837, 23.197}, {-9.837, -20.682}, {4.661, -20.682}, {4.661, -23.682}}));
