...
model RevoluteRestrainedTauControl
  Modelica.Mechanics.MultiBody.Joints.Revolute revolute(useAxisFlange = true, phi.start = 0.19, phi.fixed = true) annotation(Placement(visible = true, transformation(origin = {0, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Mechanics.MultiBody.Parts.Body body(r_CM = {0, 0.1, 0}, m = 1, r_0.start = {0, 0.5, 0}, r_0.fixed = true) annotation(Placement(visible = true, transformation(origin = {53.181, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
