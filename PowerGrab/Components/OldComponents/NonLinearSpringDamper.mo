...
model NonLinearSpringDamper
  ...
  parameter Modelica.SIunits.TranslationalDampingConstant d(final min = 0) = 0 "Damping constant";
  ...
  Modelica.Blocks.Interfaces.RealInput k "Non-linear stiffness of the spring" annotation(Placement(visible = true, transformation(origin = {2.089, -50}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-0, -17.494}, extent = {{-20, -20}, {20, 20}}, rotation = -90)));
  Modelica.Blocks.Interfaces.RealInput s2 annotation(Placement(visible = true, transformation(origin = {-100, 74.52500000000001}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-80, 80}, extent = {{-20, -20}, {20, 20}}, rotation = -360)));
  Modelica.Blocks.Interfaces.RealOutput springForce annotation(Placement(visible = true, transformation(origin = {95.717, 62.255}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {83.514, 80}, extent = {{-16.486, -16.486}, {16.486, 16.486}}, rotation = 0)));
protected
