...
model OneJointFinger "Incomplete model; does not include the newer version of the muslce model"
  ...
  Modelica.Mechanics.MultiBody.Parts.BodyCylinder FingerExtension(r = {0, 0.7, 0}, r_shape = {0, 0.35, 0}, r_0.start = {0, 0.08, 0}, r_0.fixed = false, color = {255, 65, 65}, diameter = 0.2) "Part of the finger that extends from the palm" annotation(Placement(visible = true, transformation(origin = {25, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Mechanics.MultiBody.Parts.BodyShape bodyShape(r = {0, 0.01, 0}, r_0.start = {0, 0.08, 0}, m = 0.001, r_CM = {0, 0.005, 0}) annotation(Placement(visible = true, transformation(origin = {-7.144, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Mechanics.MultiBody.Joints.Revolute revolute1(phi.start = 1.71, animation = false, n = {0, 0, -1}, useAxisFlange = false) annotation(Placement(visible = true, transformation(origin = {-30, 15}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  RevoluteRestrained revoluteRestrained(elastoBacklash.d = 50, elastoBacklash.phi_rel0 = 0, elastoBacklash.b = 4, elastoBacklash.c = 200) annotation(Placement(visible = true, transformation(origin = {-20, -8.202}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
