...
model HingeMuscleJoint
  ...
  Modelica.Mechanics.MultiBody.Parts.BodyShape bodyShape(r = {0, 0.01, 0}, r_CM = {0, 0.005, 0}, m = m, r_0.start = {x_0, y_0, z_0}, r_0.fixed = true) annotation(Placement(visible = true, transformation(origin = {0, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PowerGrab.Components.OldComponents.PrismaticRestricted prismaticRestricted(l_stop = l_stop, c_upper = 2000, d_upper = 200, c_bottom = 2000, d_bottom = 200) annotation(Placement(visible = true, transformation(origin = {1.567, -46.594}, extent = {{-10, -10}, {10, 10}}, rotation = -630)));
...
equation
  ...
  annotation(Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {10, 10}), graphics = {Ellipse(visible = true, origin = {0, -7.182}, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid, extent = {{-96.006, -90.336}, {96.006, 90.336}}), Ellipse(visible = true, origin = {0, -9.449}, fillPattern = FillPattern.Solid, extent = {{-57.452, -52.539}, {57.452, 52.539}})}), Diagram(coordinateSystem(extent = {{-148.5, -105}, {148.5, 105}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5})));
