...
equation
  ...
  annotation(Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {10, 10}), graphics = {Line(visible = true, origin = {-66.92400000000001, -3.425}, points = {{0, 76.575}, {0, -76.575}}, pattern = LinePattern.Dash), Line(visible = true, origin = {-19.022, -1.729}, points = {{-48.42, -76.608}, {96.84099999999999, 1.729}, {-48.42, 74.879}}, pattern = LinePattern.Dot), Polygon(visible = true, origin = {-19.541, -1.914}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid, points = {{-45.827, 71.914}, {91.65300000000001, 1.914}, {-45.827, -73.82899999999999}})}), Diagram(coordinateSystem(extent = {{-148.5, -105}, {148.5, 105}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5})));
end MuscleTissue2;