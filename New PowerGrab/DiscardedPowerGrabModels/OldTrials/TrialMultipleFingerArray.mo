...
model TrialMultipleFingerArray
  DiscardedPowerGrabModels.OldComponents.FinalFingerArray middleMostFinger(
    fDistalClosed=false,
    mDistalClosed=false,
    ...
    fingerLength={mFinger*0.343137255,mFinger*0.31372549,mFinger*0.196078431,
        ...
        rotation=0)));
  DiscardedPowerGrabModels.OldComponents.FinalFingerArray opposable(
    mDistalClosed=false,
    cDistalRegularClosed=false,
    fDistalClosed=false,
    cDistalSideClosed=false,
    ...
    fingerLength={tFinger*0.137931034,tFinger*0.344827586,tFinger*0.275862069,
        tFinger*0.24137931}) annotation (Placement(visible=true, transformation(
  ...
  DiscardedPowerGrabModels.OldComponents.FinalFingerArray middleLeftFinger(
    fDistalClosed=false,
    mDistalClosed=false,
    cDistalRegularClosed=false,
    cDistalSideClosed=false,
    fingerLength={rFinger*0.319148936,rFinger*0.319148936,rFinger*0.212765957,
        ...
        extent={{-12.5,-12.5},{12.5,12.5}},
        rotation=0)));
  DiscardedPowerGrabModels.OldComponents.FinalFingerArray leftMostFinger(
    fDistalClosed=false,
    mDistalClosed=false,
    cDistalRegularClosed=false,
    cDistalSideClosed=false,
    fingerLength={lFinger*0.337837838,lFinger*0.324324324,lFinger*0.168918919,
        ...
        extent={{-12.5,-12.5},{12.5,12.5}},
        rotation=0)));
  DiscardedPowerGrabModels.OldComponents.FinalFingerArray middleRight(
    fDistalClosed=false,
    mDistalClosed=false,
    cDistalRegularClosed=false,
    cDistalSideClosed=false,
