...
model ObjectConnectionToBareBoneTest
  ...
  model TestOCLFtoWholeFingerArray
    DiscardedPowerGrabModels.OldComponents.ObjectLFConnection
      objectLFConnection(threshold=0.25) annotation (Placement(visible=true,
          transformation(
          origin={-10,27.15},
          extent={{-10,-10},{10,10}},
          rotation=0)));
    ...
    DiscardedPowerGrabModels.OldComponents.ObjectLFConnection
      objectLFConnection1(threshold=0.25) annotation (Placement(visible=true,
          transformation(
          origin={5,7.491},
          extent={{-10,-10},{10,10}},
          rotation=0)));
    DiscardedPowerGrabModels.OldComponents.ObjectLFConnection
      objectLFConnection2(threshold=0.25) annotation (Placement(visible=true,
          transformation(
          origin={5,-20},
          extent={{-10,-10},{10,10}},
          rotation=0)));
