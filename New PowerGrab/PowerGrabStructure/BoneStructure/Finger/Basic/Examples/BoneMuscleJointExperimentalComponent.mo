...
model BoneMuscleJointExperimentalComponent
  ...
  Muscle.Basic.Examples.NeuralMuscle neuralMuscle(f_max_a=200, f_max_p=200)
...
equation
  connect(LoadTorque, torque.tau) annotation(Line(visible = true, origin = {131.365, -21.112}, points = {{22.094, -1.113}, {-6.365, -1.113}, {-6.365, 1.112}, {-9.365, 1.112}}, color = {0, 0, 127}));
  ...
  connect(F_P, neuralMuscle.forcePValue_p) annotation(Line(visible = true, origin = {-54.207, 58.26}, points = {{-93.907, -13.26}, {29.194, -13.26}, {29.194, 13.26}, {35.518, 13.26}}, color = {0, 0, 127}));
  connect(F_A, neuralMuscle.forcePValue_a) annotation(Line(visible = true, origin = {-54.244, 81.889}, points = {{-94.026, 3.111}, {29.231, 3.111}, {29.231, -3.111}, {35.563, -3.111}}, color = {0, 0, 127}));
