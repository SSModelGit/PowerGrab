...
model RealBoneDoubleJoint
  ...
  phi(                                                                                                           fixed =     false, start =     1.5),cylinderLength = 0.001, cylinderDiameter = 0.001) annotation(Placement(visible = true, transformation(origin = {-10, 35}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Muscle.Advanced.Subcomponents.Examples.LineMuscle lineMuscle annotation (
      Placement(visible=true, transformation(
        origin={-43.039,75},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  Muscle.Advanced.Subcomponents.Examples.LineMuscle lineMuscle1 annotation (
      Placement(visible=true, transformation(
        origin={25,75},
        extent={{10,-10},{-10,10}},
        rotation=0)));
  Muscle.Advanced.Subcomponents.Examples.LineMuscle lineMuscle2 annotation (
      Placement(visible=true, transformation(
        origin={-35,-85},
        extent={{-10,10},{10,-10}},
        rotation=0)));
  Muscle.Advanced.Subcomponents.Examples.LineMuscle lineMuscle3 annotation (
      Placement(visible=true, transformation(
        origin={25,-70},
        extent={{-10,10},{10,-10}},
        rotation=0)));
  Muscle.Advanced.Subcomponents.Examples.MagnitudeMuscle magnitudeMuscle(f_max=
        20) annotation (Placement(visible=true, transformation(
        origin={-110,-87.842},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  Muscle.Advanced.Subcomponents.Examples.MagnitudeMuscle magnitudeMuscle1(f_max=
       20) annotation (Placement(visible=true, transformation(
        origin={-115,80},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  ...
  phi(                                                                                     fixed =     false, start =     1.5),useAxisFlange = true, cylinderLength = 0.001, cylinderDiameter = 0.001) annotation(Placement(visible = true, transformation(origin = {1.225, 135}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
