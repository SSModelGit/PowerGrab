...
model MultiFingerContactTrial
  Finger.RealFingerContact middleMostFinger(
    ...
    bufferEffect=50) annotation (Placement(visible=true, transformation(
        ...
        rotation=0)));
  Finger.FingerContactArray opposable(
    mDistalClosed=false,
    cDistalRegularClosed=false,
    fDistalClosed=false,
    cDistalSideClosed=false,
  ...
  Finger.FingerContactArray middleLeftFinger(
    fDistalClosed=false,
    mDistalClosed=false,
    cDistalRegularClosed=false,
    cDistalSideClosed=false,
    ...
    annotation (Placement(visible=true, transformation(
        ...
        extent={{-12.5,-12.5},{12.5,12.5}},
        rotation=0)));
  Finger.FingerContactArray leftMostFinger(
    fDistalClosed=false,
    mDistalClosed=false,
    cDistalRegularClosed=false,
    cDistalSideClosed=false,
    ...
    annotation (Placement(visible=true, transformation(
        ...
        extent={{-12.5,-12.5},{12.5,12.5}},
        rotation=0)));
  Finger.FingerContactArray middleRight(
    fDistalClosed=false,
    mDistalClosed=false,
    cDistalRegularClosed=false,
    cDistalSideClosed=false,
  ...
  DiscardedPowerGrabModels.OldComponents.RealTestFinger realTestFinger
