...
model TestBoneJointComponent
  BoneStructure.Finger.Subcomponents.Basic.Examples.BoneJointComponent
    boneJointComponent(phi_0_restrained=0, r_OFingerBone={0.25,0,0})
  ...
  BoneStructure.Finger.Subcomponents.Basic.Examples.BoneJointComponent
    boneJointComponent1(phi_0_restrained=0.65, r_IFingerBone={0.25,0,0})
    annotation (Placement(visible=true, transformation(
        origin={63.5,0},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  Muscle.Basic.Examples.NeuralMuscle neuralMuscle1(f_max_a=200, f_max_p=200)
    annotation (Placement(visible=true, transformation(
        origin={65,42.921},
        extent={{-10,-10},{10,10}},
        rotation=0)));
