...
model TestDoubleJointFinger
  ...
  PowerGrabStructure.Tests.Basic.TestDoubleJointComponent boneCDistal(
    phi_0_doubleJoint=0,
    closedLoop=false,
  ...
  Muscle.Advanced.Subcomponents.Examples.MagnitudeMuscle magnitudeMuscle(f_max=
        200) annotation (Placement(visible=true, transformation(
        origin={-105.306,80},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  Muscle.Advanced.Subcomponents.Examples.MagnitudeMuscle magnitudeMuscle1(f_max=
       2000) annotation (Placement(visible=true, transformation(
        origin={-120,-65.414},
        extent={{-10,-10},{10,10}},
        rotation=0)));
