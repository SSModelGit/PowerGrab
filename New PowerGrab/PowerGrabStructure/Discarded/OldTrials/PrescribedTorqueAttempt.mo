...
model PrescribedTorqueAttempt "Incomplete model; does not include the newer version of the muscle model"
  ...
  PowerGrabStructure.Discarded.OldComponents.PhysicalMuscle3 physicalMuscle3(
    d_front=200,
    c_posterior=0,
    d_posterior=0,
  ...
  PowerGrabStructure.Discarded.OldComponents.BlankOutput blankOutput
